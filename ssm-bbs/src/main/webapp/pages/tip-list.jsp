                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <c:forEach items="${tips}" var="tip">
                                <tr>
                                    <td><input name="ids" type="checkbox" value="${tip.tip_id}"></td>
                                    <td>${tip.user.user_nick}</td>
                                    <td>${tip.tip_title}</td>
                                    <%--<td class="text-center">${tip.tip_content}</td>--%>
                                    <td class="text-center"><fmt:formatDate value="${tip.tip_publishTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                    <td>${tip.tip_replies}</td>
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs" onclick=location.href="${path}/tip/findTipById.do?tip_id=${tip.tip_id}">查看</button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
    ...
    $(function (){
        ...
        $("#check").click(function () {
            if(checkPassword()&&checkUserNick()) {
                var form = document.getElementById("Tab-model"); // 由id获取表单
                form.submit();//提交表单
            }
        });
    });
        ...
        $("#delete").click(function () {
            ...
            if (checkedNum >= 1) {
                ...
                if (r){
                    ...
                    location.href="${path}/tip/deleteByIds.do?ids="+ids;
                }
            }
        });
