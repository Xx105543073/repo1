...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box-body">
                <form method="post" action="${path}/tip/findTipsByWord.do">
                    <div class="row">
                        <div class="col-lg-4">
        ...
        <button class="btn btn-default" type="submit">搜索</button>
                ...
                <div class="nav-tabs-custom col-md-12">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="#1" data-toggle="tab">科技</a>
                        </li>
                        <li>
                            <a href="#2" data-toggle="tab">学习</a>
                        </li>
                        <li>
                            <a href="#3" data-toggle="tab">生活</a>
                        </li>
                        <li>
                            <a href="#4" data-toggle="tab">其他</a>
                        </li>
